...
#
# Github:
# https://github.com/yoshisatoh/Data_Pre-processing/tree/main/data_split/train_validation_and_test/temporal/data_split_train_valid_and_test__temporal.py
# https://github.com/yoshisatoh/Data_Pre-processing/blob/main/data_split/train_validation_and_test/temporal/data_split_train_valid_and_test__temporal.py
#
#
########## Input Data File(s)
#
...
#
#python data_split_train_valid_and_test__temporal.py df.csv y date 0.8 0.1
#
#Generally,
#python data_split_train_valid_and_test__temporal.py (dfname: data file name) (column name of target y to predict) (column in datetime type) (train_size) (valid_size)
#
