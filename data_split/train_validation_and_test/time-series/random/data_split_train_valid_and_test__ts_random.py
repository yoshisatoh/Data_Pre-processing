...
#
# Github:
# https://github.com/yoshisatoh/Data_Pre-processing/tree/main/data_split/train_validation_and_test/time-series/random/data_split_train_valid_and_test__ts_random.py
# https://github.com/yoshisatoh/Data_Pre-processing/blob/main/data_split/train_validation_and_test/time-series/random/data_split_train_valid_and_test__ts_random.py
#
#
########## Input Data File(s)
#
...
#
#python data_split_train_valid_and_test__ts_random.py df.csv y date 0.8 0.1 None
#python data_split_train_valid_and_test__ts_random.py df.csv y date 0.8 0.1 1
#
#Generally,
