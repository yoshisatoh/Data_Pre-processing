...
#
# Github:
# https://github.com/yoshisatoh/Data_Pre-processing/tree/main/NLP/sec-edgar_api_data_nlp/sec-edgar_api_3_getfilings.py
# https://github.com/yoshisatoh/Data_Pre-processing/blob/main/NLP/sec-edgar_api_data_nlp/sec-edgar_api_3_getfilings.py
#
#
########## Input Data File(s)
#
...
#python sec-edgar_api_3_getfilings.py CIKs.txt
#
#Generally,
#python sec-edgar_api_3_getfilings.py (arg_CIKs_file_name)
#
#
########## Output Data File(s)
#
