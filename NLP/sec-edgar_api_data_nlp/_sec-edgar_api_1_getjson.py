...
#
# Github:
# https://github.com/yoshisatoh/Data_Pre-processing/tree/main/NLP/sec-edgar_api_data_nlp/sec-edgar_api_1_getjson.py
# https://github.com/yoshisatoh/Data_Pre-processing/blob/main/NLP/sec-edgar_api_data_nlp/sec-edgar_api_1_getjson.py
#
#
########## Input Data File(s)
#
...
#python sec-edgar_api_1_getjson.py CIKs.txt
#
#Generally,
#python sec-edgar_api_1_getjson.py (arg_CIKs_file_name)
#
#
########## Output Data File(s)
#
