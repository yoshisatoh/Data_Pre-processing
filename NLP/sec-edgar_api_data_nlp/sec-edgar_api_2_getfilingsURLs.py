...
#
# Github:
# https://github.com/yoshisatoh/Data_Pre-processing/tree/main/NLP/sec-edgar_api_data_nlp/sec-edgar_api_2_getfilingsURLs.py
# https://github.com/yoshisatoh/Data_Pre-processing/blob/main/NLP/sec-edgar_api_data_nlp/sec-edgar_api_2_getfilingsURLs.py
#
#
########## Input Data File(s)
#
...
#python sec-edgar_api_2_getfilingsURLs.py CIKs.txt 10-K
#
#Generally,
#python sec-edgar_api_2_getfilingsURLs.py (arg_CIKs_file_name) (arg_doc_type)
#
#
########## Output Data File(s)
#
